...
function initMap() {
  ...
  // Ajout du contrôleur de couches (si ol-layerswitcher est chargé)
  if (typeof ol.control.LayerSwitcher !== 'undefined') {
    const layerSwitcher = new ol.control.LayerSwitcher();
    map.addControl(layerSwitcher);
  } else {
    console.warn("Le contrôleur de couches n'est pas disponible. Vérifiez que ol-layerswitcher est chargé.");
  }
}
