...
// Initialisation de la carte avec zoom min/max
const map = new ol.Map({
  target: 'map',
  layers: [
    new ol.layer.Tile({
      source: new ol.source.XYZ({
        url: 'https://data.geopf.fr/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=GEOGRAPHICALGRIDSYSTEMS.PLANIGNV2&STYLE=normal&TILEMATRIXSET=PM&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}&FORMAT=image/jpeg',
        attributions: '© <a href="https://www.geoportail.gouv.fr/">IGN</a>'
      }),
      minZoom: 12,
      maxZoom: 16
    }),
...
// Vérifier si une trace est en cours au chargement
window.addEventListener('load', () => {
