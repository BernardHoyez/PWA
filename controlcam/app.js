...
const { Camera, SwitchCamera, Circle, Download, Zap, ZapOff, Grid3x3, Smartphone, Monitor, Copy, Check, Video, Wifi } = lucide;
...
function RemoteCameraApp() {
  ...
  const copyUrl = () => {
    const url = `${window.location.origin}/PWA/controlcam/?device=${deviceId}`;
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-pink-900 flex items-center justify-center p-6">
        <div className="max-w-4xl w-full">
          <div className="text-center mb-12">
            <Icon icon={Camera} className="w-20 h-20 text-white mx-auto mb-4" />
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              <Icon icon={Smartphone} className="w-16 h-16 text-blue-400 mx-auto mb-4" />
            ...
            <button
              ...
              className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 hover:bg-white/20 transition-all transform hover:scale-105"
            >
              <Icon icon={Monitor} className="w-16 h-16 text-purple-400 mx-auto mb-4" />
      ...
      <div className="min-h-screen bg-black flex flex-col">
        <div className="bg-gradient-to-b from-black/90 to-transparent absolute top-0 left-0 right-0 z-20 p-4">
          <div className="flex items-center justify-between mb-4">
            ...
            >
              <Icon icon={Grid3x3} className="w-5 h-5 text-white" />
            </button>
            
            <div className="flex items-center gap-2 bg-green-500 px-4 py-2 rounded-full">
              <Icon icon={Wifi} className="w-4 h-4 text-white animate-pulse" />
            ...
            >
              <Icon icon={flash ? Zap : ZapOff} className="w-5 h-5 text-white" />
            </button>
          </div>
          ...
          <div className="bg-black/50 backdrop-blur-lg rounded-xl p-4 flex items-center justify-between">
            ...
            >
              <Icon icon={copied ? Check : Copy} className="w-4 h-4 text-white" />
          ...
          {error && (
            <div className="absolute inset-0 flex items-center justify-center bg-black z-30">
              <div className="text-center px-6">
                <Icon icon={Camera} className="w-16 h-16 text-red-500 mx-auto mb-4" />
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2">
            <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
              {liveView ? (
                ...
                <div className="w-full aspect-video flex items-center justify-center bg-slate-800">
                  <Icon icon={Camera} className="w-20 h-20 text-white/20" />
                </div>
              )}
            </div>
            ...
            <div className="grid grid-cols-5 gap-4 mt-6">
              ...
              >
                <Icon icon={Circle} className="w-8 h-8 text-white" />
              ...
              >
                <Icon icon={SwitchCamera} className="w-8 h-8 text-white" />
              ...
              >
                <Icon icon={Zap} className="w-8 h-8 text-white" />
              ...
              >
                <Icon icon={Grid3x3} className="w-8 h-8 text-white" />
              ...
              >
                <Icon icon={Video} className="w-8 h-8 text-white" />
              ...
              {photos.length === 0 ? (
                ...
                photos.map((photo, i) => (
                  <div key={i} className="relative group">
                    ...
                    >
                      <Icon icon={Download} className="w-4 h-4 text-white" />
                    </button>
                  </div>
                ))
              )}
