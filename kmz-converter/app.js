...
async function downloadModifiedKmz() {
    ...
    try {
        ...
        processedImages.forEach(img => {
            ...
            // Find and replace the name in <n><![CDATA[...]]></n>
            // OruxMaps structure: <n><![CDATA[0001852]]></n>
            ...
            if (match) {
                console.log(`  ✓ Name pattern matched, replacing "${match[2]}" with "${data.name}"`);
                modifiedKml = modifiedKml.replace(placemarkPattern, `$1${data.name}$3`);
            } else {
                console.log(`  ✗ Name pattern NOT matched`);
            }
