    ...
    try {
        ...
        processedImages.forEach(img => {
            ...
            if (placemarkMatch) {
                ...
                if (nameMatch) {
                    console.log(`  ✓ Found name: "${nameMatch[2]}" (was empty: ${nameMatch[2] === ''})`);
                    ...
                    console.log(`  ✗ Could not find <name><![CDATA[...]]></name> pattern`);
                    console.log(`  Placemark content:`, placemarkContent.substring(0, 300));
                }
            } else {
