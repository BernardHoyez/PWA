...
// Mise à jour de la liste des POI avec boutons Modifier/Supprimer explicites
...
// Map (Leaflet) avec icône personnalisée
const netMarkerIcon = L.icon({
...
function setMapMarker(lat, lon) {
  ...
  marker = L.marker([lat, lon], {icon: netMarkerIcon}).addTo(map);
}
