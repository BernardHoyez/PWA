...
document.getElementById("photoInput").addEventListener("change", function(e) {
  ...
  if (typeof EXIF === 'undefined') {
    alert('❌ Librairie EXIF non chargée');
    return;
  }

  document.getElementById('status').textContent = 'Lecture EXIF...';
  ...
  EXIF.getData(file, function() {
    ...
    if (!lat || !lon) {
      ...
      document.getElementById('status').textContent = 'Aucune coordonnée trouvée';
      return;
    }
    ...
    document.getElementById('status').textContent = '✅ Position affichée';
  });
});
