...
<script id="gpxData" type="application/xml">${gpx}</script>
<script src="https://unpkg.com/leaflet/dist/leaflet.js"></script>

<script>
const xml=new DOMParser().parseFromString(
  document.getElementById("gpxData").textContent,"application/xml");
...
L.control.layers({"IGN Plan V2":ign,"OSM":osm}).addTo(map);
