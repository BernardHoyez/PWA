...
async function exportPDF(){
  ...
  try{
    ...
    // Fermer tous les popups pour éviter les interférences
    map.closePopup();
    
    // Forcer l'invalidation de la taille de la carte
    map.invalidateSize();
    
    // Attendre que toutes les tuiles soient chargées avec un timeout plus long
    ...
    // Attendre un délai supplémentaire pour être certain que tout est rendu
    await new Promise(resolve => setTimeout(resolve, 1500));
    
    // Forcer un repaint de la carte
    map.invalidateSize();
