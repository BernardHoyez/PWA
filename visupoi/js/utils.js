// utils.js — fonctions géo et format
...
// convert from mathematical bearing (from East) to compass bearing (from North)
// The formula above returns bearing clockwise from North (0° = North), so normalize
θ = (θ + 360) % 360;
return θ; // degrees 0..359
}
...
// expose for use in non-module environment
