...
const CACHE_NAME = 'visite-editeur-cache-v5';
const urlsToCache = [
    '/',
    '/index.html',
    '/manifest.json',
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        const promises = urlsToCache.map(url => {
            // Utiliser une requête standard pour les ressources cross-origin
      ...
      .then(response => {
        ...
        return fetch(event.request).then(
          response => {
            ...
            // Gérer les erreurs réseau pour les requêtes non mises en cache
